...
#split objects inside transactions
...
for i in daily_transactions_split:
  for n in i: 
    inside.append(n.strip())
  transactions_clean.append(inside)
  inside = []
...
print("Today we sold ")
for color in colors: 
  print("{total} of {color} threads, ".format(total=color_count(color),color=color))